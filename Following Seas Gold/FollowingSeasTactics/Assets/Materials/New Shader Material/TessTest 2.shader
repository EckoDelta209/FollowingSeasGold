Shader "Toon/Lit TriPlanar w/ Phong Tessellation" {
    Properties {
        ...
        _RimPower("Rim Power", Range(-2,20)) = 10
    ...
    SubShader {
        ...
        CGPROGRAM
		#pragma surface surf ToonRamp vertex:dispNone tessellate:tessEdge tessphong:_Phong nolightmap
    ...
    void surf(Input IN, inout SurfaceOutput o) {
        ...
        //#pragma surface surf ToonRamp /*Lambert*/ vertex:dispNone tessellate:tessEdge tessphong:_Phong nolightmap
        //#include "Tessellation.cginc"
